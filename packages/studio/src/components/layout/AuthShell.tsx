    ...
    <div className="grid min-h-dvh place-items-center bg-bg px-4">
      <div className="w-full max-w-sm">
        <div className="mb-6 flex items-center justify-center gap-2">
          <span className="grid size-7 place-items-center rounded bg-accent text-[12px] font-bold text-on-accent">E</span>
          <span className="text-[15px] font-semibold tracking-tight">Enkaku</span>
        </div>
        <div className="rounded-xl border bg-panel p-6 shadow-sm">
          <h1 className="text-[15px] font-semibold tracking-tight">{title}</h1>
          <p className="mt-1 text-[12.5px] leading-relaxed text-dim">{description}</p>
