...
const params = z.object({
  ...
  */
  deviceIds: z
    ...
    .optional()
    .describe('Which phones this post may go to. Leave empty for any phone carrying the platform’s label; choose phones and those phones are used as chosen, labelled or not.')
