 ...
 *
 * Every run pushes its video to `/sdcard/DCIM/Camera/yt-<job id>-<attempt>.<ext>` and nothing ever removed it. Before
...
const PUSHED_NAME = /^yt-[0-9a-f]{8}-[0-9a-f-]{27}-\d+\.(mp4|mov|m4v|webm|mkv|3gp)$/i
