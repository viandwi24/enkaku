 ...
 *
 * Published as a one-member plugin — the only shape there is (plan 110 §3.1).
 */
export default definePlugin({
  id: 'debug-node',
  version: '1.1.0',
  title: 'Debug node',
  description: 'A selector probe: what does this selector really match on this screen?',
  scripts: [
    {
      id: 'main',
      title: 'Resolve a selector',
      description: 'Resolves one selector and reports its class, bounds, size and tap centre.',
      params: z.object({
