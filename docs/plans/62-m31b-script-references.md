...
> Status: not started
> Ships: `packages/core/src/scripts/routes.ts`, `packages/core/src/services/job-service.ts`, `packages/core/src/schedule/*`, `packages/protocol/src/messages/job.ts`, `packages/studio/src/app/scripts/`, `packages/studio/src/components/RunScriptDialog.tsx`, one Drizzle migration
